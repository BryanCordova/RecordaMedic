          ...
          <div className="space-y-2">
            ...
            {availableMedicamentos.length === 0 && (
              <p className="text-sm text-amber-500 mt-1">
                {isAdminContext ? "Este paciente no tiene medicamentos registrados. Añade medicamentos al paciente primero." : "No hay medicamentos registrados. Añade medicamentos primero desde la sección 'Medicamentos'."}
              </p>
            )}
          </div>
